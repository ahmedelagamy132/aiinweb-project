                ...
                <div key={index} className="tool-call-card">
                    ...
                    <div className="tool-output">
                        <details>
                            ...
                            <pre className="tool-output-preview">{call.output_preview}</pre>
                        </details>
                    </div>
                </div>
            )),
        ...
        <div>
            ...
            {result && (
                <div className="agent-results">
                    ...
                    <div className="content-box">
                        <h3>
                            <Wrench size={20} style={{ display: 'inline-block', marginRight: '8px', verticalAlign: 'middle' }} />
                            Tool Calls ({result.tool_calls?.length || 0})
                        </h3>
                        <p className="text-secondary" style={{ marginBottom: '16px', fontSize: '14px' }}>
                            Shows which tools the AI agent used to gather information
                        </p>
                        <div className="tool-calls-grid">{toolCallsList}</div>
                    </div>
                    ...
                    {result.plan?.steps?.length > 0 && (
                        <div className="content-box">
                            <h3>
                                ...
                                Generated Plan ({result.plan.steps.length} steps)
                                <span className="badge">AI-Generated</span>
                            </h3>
                            <p className="text-secondary" style={{ marginBottom: '16px' }}>
                                Plan dynamically generated by LLM based on route requirements and risks
                            </p>
                            <ul className="list">
                                {result.plan.steps.slice(0, 3).map((step, index) => (
                                    <li key={index} className="list-item">
                                        ...
                                        <small>Owner: {step.owner} | Duration: {step.duration_minutes} min</small>
                                    </li>
                                ))}
